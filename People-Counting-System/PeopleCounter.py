...
##    frame = image.array
    ...
    try:
        ...
        print('EOF')
        print( 'Giren:',cnt_up)
        print ('Cikan:',cnt_down)
        print ('Iceride Toplam Kisi:',cnt_down-cnt_up)
        break
    #################
    #   CONTORNOS   #
    #################
    ...
    str_giren = 'Giren: '+ str(cnt_up)
    str_cikan = 'Cikan: '+ str(cnt_down)
    str_top = 'Iceride: '+ str(cnt_up-cnt_down)
    frame = cv.polylines(frame,[pts_L1],False,line_up_color,thickness=2)
    frame = cv.polylines(frame,[pts_L2],False,line_down_color,thickness=2)
    ...
    cv.putText(frame, str_giren ,(10,40),font,0.5,(255,255,255),2,cv.LINE_AA)
    cv.putText(frame, str_giren ,(10,40),font,0.5,(255,0,0),1,cv.LINE_AA)
    cv.putText(frame, str_cikan ,(10,60),font,0.5,(255,255,255),2,cv.LINE_AA)
    cv.putText(frame, str_cikan ,(10,60),font,0.5,(255,0,0),1,cv.LINE_AA)
    cv.putText(frame, str_top ,(10,80),font,0.5,(255,255,255),2,cv.LINE_AA)
    cv.putText(frame, str_top ,(10,80),font,0.5,(255,0,0),1,cv.LINE_AA)
